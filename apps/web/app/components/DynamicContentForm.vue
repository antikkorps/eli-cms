    ...
    if (f.defaultValue !== undefined && f.defaultValue !== null) {
      ...
      switch (f.type) {
        case 'boolean':
          ...
          break;
        case 'number':
          block[f.name] = undefined;
          break;
        case 'repeatable':
          block[f.name] = [];
          break;
        case 'media':
          block[f.name] = f.multiple ? [] : null;
          break;
        default:
          block[f.name] = '';
          break;
...
const tabItems = computed(() => groupNames.value.map((name) => ({ label: name, value: name })));
            ...
            >
              ...
              >
                ...
                <MediaPicker
                  ...
                  :model-value="
                    sub.multiple ? ((item[sub.name] as string[]) ?? []) : ((item[sub.name] as string) ?? null)
                  "
          ...
          <div class="space-y-3 w-full">
            ...
            >
              ...
              <div class="p-4 space-y-3">
                <template
                  v-for="compField in componentMap.get(block._component as string)?.fields ?? []"
                  :key="compField.name"
                >
                  <UFormField
                  ...
                  >
                    <UInput
                      ...
                      class="w-full"
                      @update:model-value="
                        (v: string) => updateComponentBlockField(field.name, blockIndex, compField.name, v)
                      "
                    />
                    ...
                    <UInput
                      ...
                      class="w-full"
                      @update:model-value="
                        (v: number) => updateComponentBlockField(field.name, blockIndex, compField.name, v)
                      "
                    />
                    ...
                    <USwitch
                      ...
                      @update:model-value="
                        (v: boolean) => updateComponentBlockField(field.name, blockIndex, compField.name, v)
                      "
                    />
                    ...
                    <MediaPicker
                      ...
                      :model-value="
                        compField.multiple
                          ? ((block[compField.name] as string[]) ?? [])
                          : ((block[compField.name] as string) ?? null)
                      "
                      :multiple="compField.multiple"
                      :accept="compField.accept"
                      @update:model-value="
                        (v: any) => updateComponentBlockField(field.name, blockIndex, compField.name, v)
                      "
                    />
                    ...
                    <AuthorPicker
                      ...
                      @update:model-value="
                        (v: string | null) => updateComponentBlockField(field.name, blockIndex, compField.name, v)
                      "
                    />
