...
export function useAvatar() {
  ...
  function userAvatarUrl(user: { email: string; avatarStyle?: string | null; avatarSeed?: string | null }, size = 64): string {
  ...
  const SEED_WORDS = [
    'aurora', 'nebula', 'crystal', 'ember', 'frost', 'shadow', 'breeze', 'coral',
    'dusk', 'echo', 'fern', 'glow', 'haze', 'iris', 'jade', 'luna',
    'maple', 'nova', 'opal', 'pearl', 'quartz', 'rain', 'sage', 'tide',
    'vine', 'wave', 'zenith', 'bloom', 'cedar', 'delta', 'flint', 'grove',
  ];
